ActionController::Routing::Routes.draw do |map|
  ...
  # default
  map.root :controller  => 'Ivana::Ivana', :action => 'index'
  map.resources :articles, :controller  => 'Articles', :action => 'index'
  # for Filemanager
  ...
  map.admin 'admin', :controller  => 'admin/dashboard', :action => 'index'
    ...
    map.namespace(:ivana) do |ivana|
    ivana.resources :ivana
    ivana.resources :o_me
    end
